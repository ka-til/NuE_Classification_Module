...
**IceTray environment:**
`eval \`/cvmfs/icecube.opensciencegrid.org/py3-v4.3.0/setup.sh /cvmfs/icecube.opensciencegrid.org/py3-v4.3.0/RHEL_7_x86_64/metaprojects/icetray/v1.9.2/env-shell.sh\``
